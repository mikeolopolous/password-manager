...
website_entry = tk.Entry(width=38, bg="white", fg="black", highlightthickness=0)
website_entry.grid(column=1, row=1, columnspan=2)

username_label = tk.Label(text="Email/Username:", bg="white", fg="black")
username_label.grid(column=0, row=2)

username_entry = tk.Entry(width=38, bg="white", fg="black", highlightthickness=0)
...
add_button = tk.Button(text="Add", width=36, highlightbackground="white")
